...
class Settings(BaseSettings):
    ...
    # WhatsApp bridge (self-hosted Baileys sender). The backend talks to it
    # over the internal Docker network; the token must match the bridge's
    # BRIDGE_TOKEN env var.
    WA_BRIDGE_URL: str = "http://wa-bridge:8080"
    WA_BRIDGE_TOKEN: str = ""
